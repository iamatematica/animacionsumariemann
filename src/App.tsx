      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-24">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="bg-indigo-950/60 p-8 md:p-12 rounded-3xl border border-indigo-800/50 inline-block backdrop-blur-sm">
              <div className="flex items-center gap-4 md:gap-8 text-2xl md:text-4xl font-serif">
                
                {/* Integral */}
                <div className="flex items-center">
                  <div className="relative inline-flex items-center h-24 md:h-40 pr-4">
                    <span className="text-7xl md:text-9xl font-light italic leading-none">∫</span>
                    {/* Top limit b: positioned to the right of the top hook */}
                    <span className="absolute top-1 left-[70%] md:left-[75%] text-sm md:text-xl">b</span>
                    {/* Bottom limit a: positioned to the right of the bottom hook */}
                    <span className="absolute bottom-1 left-[40%] md:left-[45%] text-sm md:text-xl">a</span>
                  </div>
                  <div className="ml-4 md:ml-6">f(x) dx</div>
                </div>

                <div className="mx-2 md:mx-4 font-sans font-light text-3xl md:text-5xl">=</div>
                
                {/* Limit */}
                <div className="flex flex-col items-center justify-center">
                  <span className="text-3xl md:text-5xl font-bold leading-none">lim</span>
                  <span className="text-xs md:text-sm mt-2">n → ∞</span>
                </div>
                
                {/* Summation */}
                <div className="flex flex-col items-center justify-center mx-2">
                  <span className="text-sm md:text-lg mb-1">n</span>
                  <span className="text-5xl md:text-7xl leading-none">∑</span>
                  <span className="text-sm md:text-lg mt-1">i=1</span>
                </div>
